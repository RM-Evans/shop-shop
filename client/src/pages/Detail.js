...
function Detail() {
  ...
  const addToCart = () => {
    ...
    //if item in cart already, increase quantity
    if (itemInCart) {
      dispatch({
      ...
      //everytime we update global state, the update will reflect in indexedDB
      ...
      {currentProduct ? (
        <div className="container my-1">
          ...
          <p>
            ...
            <button
              //if no items, disable remove from cart button
